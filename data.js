...
const SOURCES = {
  ...
  tt_beinan: {
    label: '卑南鄉公所 115年度部落豐年祭(收穫、小米祭)辦理日期',
    url: 'https://www.beinan.gov.tw/%E5%8D%91%E5%8D%97%E9%84%89%E3%80%8C115%E5%B9%B4%E5%BA%A6%E8%B1%90%E5%B9%B4%E7%A5%AD%E6%94%B6%E7%A9%AB%E3%80%81%E5%B0%8F%E7%B1%B3%E7%A5%AD%E3%80%8D%E8%BE%A6%E7%90%86%E6%97%A5%E6%9C%9F/'
  },
  tt_summary: {
    label: '2026 臺東豐年祭整理頁',
...
const EVENTS = [
  ...
  { id:'tt-cb-09', buluo_id:'ami-koladot', group:'ami', chinese:'樟原部落', amis:'', county:'臺東縣', township:'長濱鄉', lat:23.327, lng:121.443, date:'7/16–7/18', venue:'樟原活動中心', status:'confirmed', src:'tt_changbin_poster', note:'原定7/11–7/13，因巴威颱風影響改期至7/16–7/18（來源同海報貼文下方留言更新，2026-07-14）。' },
  ...
  { id:'tt-cb-15', buluo_id:'ami-polot', group:'ami', chinese:'大峰峰部落', amis:"Polo't", county:'臺東縣', township:'長濱鄉', lat:23.43332, lng:121.49139, date:'7/10 五–7/12 日', welcome_date:'7/12', welcome_time:'18:00', venue:'大峰峰尖石沙灘', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟經比對該頁面並未列出本部落。長濱鄉公所 115年度豐年祭公告（tt_changbin_poster）亦未包含本部落，日期/場地待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  ...
  { id:'tt-bn-09', buluo_id:'ami-kalitood', group:'ami', chinese:'山里部落', amis:"Kalito'od", county:'臺東縣', township:'卑南鄉', lat:22.776133, lng:121.062303, date:'7/10 五–7/12 日', welcome_date:'7/11', welcome_time:'15:00', venue:'山里部落多功能聚會所（卑南鄉山里路40-1號）', status:'confirmed', src:'tt_beinan' },
  ...
  { id:'tt-tt-13', buluo_id:'ami-pongodan', group:'ami', chinese:'大橋部落', amis:'Pongodan', county:'臺東縣', township:'臺東市', lat:22.786357, lng:121.130345, date:'7/5 日–7/10 五', welcome_date:'7/10', welcome_time:'10:00', venue:'大橋部落聚會所（臺東志航路一段412巷17弄38號）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟經逐列比對該頁面並未列出本部落。亦未能尋得臺東市公所現行（2026年度）逐部落公告可核實，日期/場地待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-tt-14', buluo_id:'ami-alapanay', group:'ami', chinese:'阿拉巴奈部落', amis:'Alapanay', county:'臺東縣', township:'臺東市', lat:22.736006, lng:121.119305, date:'7/5 日–7/11 六', welcome_date:'7/11', welcome_time:'11:00', venue:'東豐社區（臺東市中華路3段208巷內）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟經逐列比對該頁面並未列出本部落。亦未能尋得臺東市公所現行（2026年度）逐部落公告可核實，日期/場地待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-tt-15', buluo_id:'ami-fukid', group:'ami', chinese:'新馬蘭部落', amis:'Fukid', county:'臺東縣', township:'臺東市', lat:22.771096, lng:121.133651, date:'7/5 日–7/11 六', welcome_date:'7/11', welcome_time:'10:00', venue:'新馬蘭聚會所（臺東市青島街1號）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；臺東縣官方 abm.ttweb.tw 雖列有本部落（聚會所名稱相符），但日期欄位標示「部落研議中」、迎賓時間亦與本筆不同，故日期未經核實，待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-tt-16', buluo_id:'ami-apapuro', group:'ami', chinese:'高坡部落', amis:'Apapuro', county:'臺東縣', township:'臺東市', lat:22.738447, lng:121.125807, date:'7/7 二–7/9 四', welcome_date:'7/9', welcome_time:'10:00', venue:'臺東市中華路二段806號（旁邊空地）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟經逐列比對該頁面並未列出本部落。亦未能尋得臺東市公所現行（2026年度）逐部落公告可核實，日期/場地待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-tt-17', buluo_id:'ami-kakawasan', group:'ami', chinese:'石山部落', amis:'Kakawasan', county:'臺東縣', township:'臺東市', lat:22.782816, lng:121.161629, date:'7/8 三–7/11 六', welcome_date:'7/11', welcome_time:'19:30', venue:'富豐里活動中心（臺東市吉林路一段279巷58號）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟經逐列比對該頁面並未列出本部落。亦未能尋得臺東市公所現行（2026年度）逐部落公告可核實，日期/場地待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-tt-18', buluo_id:'ami-pasawali', group:'ami', chinese:'巴沙哇力部落', amis:'Pasawali', county:'臺東縣', township:'臺東市', lat:22.792248, lng:121.185205, date:'7/9 四–7/12 日', welcome_date:'7/12', welcome_time:'19:00', venue:'巴沙哇力聚會所（臺東市吉林路二段699巷22號）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟經逐列比對該頁面並未列出本部落。亦未能尋得臺東市公所現行（2026年度）逐部落公告可核實，日期/場地待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-tt-19', buluo_id:'ami-karoroan', group:'ami', chinese:'加路蘭部落', amis:'Karoroan', county:'臺東縣', township:'臺東市', lat:22.810601, lng:121.188137, date:'7/10 五–7/12 日', welcome_date:'7/12', welcome_time:'13:30', venue:'加路蘭活動中心（臺東市合江路220巷58號）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟經逐列比對該頁面並未列出本部落。亦未能尋得臺東市公所現行（2026年度）逐部落公告可核實，日期/場地待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-tt-20', buluo_id:'ami-sihodingan', group:'ami', chinese:'常德部落', amis:'Sihodingan', county:'臺東縣', township:'臺東市', lat:22.749002, lng:121.133169, date:'7/10 五–7/11 六', welcome_date:'7/11', welcome_time:'10:00', venue:'臺東市常德路145巷17號（7-11冠美門市對面）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟經逐列比對該頁面並未列出本部落。亦未能尋得臺東市公所現行（2026年度）逐部落公告可核實，日期/場地待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-tt-21', buluo_id:'ami-pakurung', group:'ami', chinese:'巴古崙岸部落', amis:'Pakurung', county:'臺東縣', township:'臺東市', lat:22.759173, lng:121.054753, date:'7/13 一–7/18 六', welcome_date:'7/18', welcome_time:'09:30', venue:'臺東市射馬干生態園區（射馬干段79-3號）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟經逐列比對該頁面並未列出本部落。亦未能尋得臺東市公所現行（2026年度）逐部落公告可核實，日期/場地待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  ...
  // ══ 臺東縣 鹿野鄉 ════════════════════════════════════════════════
  { id:'tt-ly-01', buluo_ids:['ami-kanaopu','ami-efong'], group:'ami', chinese:'卡拿吾部部落／瑞源部落', amis:"Kanao'pu / Efong", county:'臺東縣', township:'鹿野鄉', lat:22.956109, lng:121.15455, date:'7/9 四–7/12 日', welcome_date:'7/11', welcome_time:'20:00', venue:'瑞源瑞隆文化聚會所', status:'confirmed', src:'tt_zhishi', note:'來源列為兩個獨立部落但同日同場地舉行，本站合併為一筆；部落識別資料庫仍將兩者列為不同登記部落，reconciliation 待辦見 docs/ROADMAP-v2.md。另，src（tt_zhishi）之日期/場地未能於 abm.ttweb.tw（未涵蓋鹿野鄉，無此鄉鎮選項）或鄉公所現行公告中獨立核實，待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-ly-02', buluo_id:'ami-salinliw', group:'ami', chinese:'山領榴部落', amis:'Salinliw', county:'臺東縣', township:'鹿野鄉', lat:22.937634, lng:121.142257, date:'7/10 五–7/12 日', welcome_date:'7/11', welcome_time:'00:00', venue:'永隆多功能活動中心', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟該頁面並未涵蓋鹿野鄉（無此鄉鎮選項），故無法核實。亦未找到鄉公所可核實本部落日期/場地之現行（2026年度）官方公告，待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-ly-03', buluo_id:'ami-pailasan', group:'ami', chinese:'八伊拉善部落', amis:'Pailasan', county:'臺東縣', township:'鹿野鄉', lat:22.97, lng:121.15, date:'7/17 五–7/19 日', welcome_date:'7/18', welcome_time:'10:00', venue:'寶華展售中心', status:'confirmed', src:'tt_zhishi', note:'座標歷史：原始 tt_zhishi 座標（22.097, 121.173）明顯偏離鹿野鄉其他部落聚落（皆約北緯22.9–23.0度），研判為資料誤植；本欄位 lat/lng 改用鹿野鄉概略座標作為 fallback。惟 BULUO_REF[ami-pailasan] 現已有 TICD 來源之 exact 座標（22.973832, 121.173231），依 eventCoord() 優先序，地圖圖釘實際上已採用該精確座標——本欄位僅為未實際使用的 fallback 值，非目前顯示座標。src（tt_zhishi）之日期/場地資訊仍未能於 abm.ttweb.tw（未涵蓋鹿野鄉）或鄉公所現行公告中獨立核實，待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-ly-04', buluo_id:'ami-rekat', group:'ami', chinese:'永昌部落', amis:'Rekat', county:'臺東縣', township:'鹿野鄉', lat:22.931221, lng:121.138782, date:'7/17 五–7/19 日', welcome_date:'7/18', welcome_time:'15:00', venue:'永昌活動中心', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟該頁面並未涵蓋鹿野鄉（無此鄉鎮選項），故無法核實。亦未找到鄉公所可核實本部落日期/場地之現行（2026年度）官方公告，待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-ly-05', buluo_id:'ami-pakalaac', group:'ami', chinese:'瑞興部落', amis:"Pakala'ac", county:'臺東縣', township:'鹿野鄉', lat:22.979323, lng:121.155733, date:'7/31 五–8/2 日', welcome_date:'8/1', welcome_time:'19:30', venue:'瑞興活動中心', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟該頁面並未涵蓋鹿野鄉（無此鄉鎮選項），故無法核實。亦未找到鄉公所可核實本部落日期/場地之現行（2026年度）官方公告，待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
  { id:'tt-ly-06', buluo_id:'ami-parayapay', group:'ami', chinese:'巴拉雅拜部落', amis:'Parayapay', county:'臺東縣', township:'鹿野鄉', lat:22.893369, lng:121.137013, date:'7/10 五–7/12 日', welcome_date:'7/11', welcome_time:'21:00', venue:'和平社區活動中心', status:'confirmed', src:'tt_zhishi', note:'2026-07-14 v2-S 查核過程新增：原懷疑「巴拉雅拜部落」為 tt-ly-03 八伊拉善部落之異名，經比對 taitung-festival 座標、部落官方網站（palayabay.apc.atipd.tw）、中央社／ETtoday／青年日報／蕃新聞等多方獨立來源後確認，實為鹿野鄉獨立、先前未收錄之部落（族語 Parayapay，舊稱擺仔擺），與成功鎮同名之「和平部落」（Kahciday, ami-kahciday）為互不相關的兩個不同部落。日期／場地資訊僅來自 src（tt_zhishi），未經第一手來源獨立核實。' },

  // ══ 臺東縣 關山鎮 ════════════════════════════════════════════════
  { id:'tt-gs-01', buluo_id:'ami-himoti', group:'ami', chinese:'電光部落', amis:'Himoti', county:'臺東縣', township:'關山鎮', lat:23.007585, lng:121.173603, date:'8/7 五–8/9 日', welcome_date:'8/8', welcome_time:'11:00', venue:'電光社區活動中心（關山鎮電光里中興102號）', status:'confirmed', src:'tt_zhishi', note:'來源 tt_zhishi 為第三方轉載站；其資料聲稱源自臺東縣官方 abm.ttweb.tw，惟該頁面並未涵蓋關山鎮（無此鄉鎮選項），故無法核實。關山鎮公所115年度公告僅為全國性歲時祭儀放假日期通函，未列各部落個別日期/場地，待第一手來源確認（見 docs/ROADMAP-v2.md v2-S）。' },
