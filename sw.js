...
const NETWORK_FIRST = new Set(['/', '/index.html', '/app.css', '/app.js', '/data.js', '/buluo-ref.js', '/manifest.json', '/js/timeline.js', '/js/map.js', '/js/search.js', '/js/info.js']);
